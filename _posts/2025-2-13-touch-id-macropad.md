...
<img title="My custom TouchID Sensor integrated into a Grid100 macropad" alt="My custom TouchID Sensor integrated into a Grid100 macropad" src="/assets/images/grid 100_files/GridWorkingAgain.jpg">
...
<img title="The Grid 100 Macropad" alt="The Grid 100 Macropad" src="/assets/images/grid 100_files/grid+100+IC+images+20230406X40.jpg">
...
<img  title="The grid 100 Macropad" alt="The grid 100 Macropad" src="/assets/images/grid 100_files/grid+100+IC+images+20230406X5.jpg">
*Photo source: [Grid 100 Official Website](https://www.gridishere.com/work/grid-100){:target="_blank"}*

It easily allows you to swap out the modules into any configuration you want to fit your needs. 
<img title="The grid 100 Macropad" alt="The grid 100 Macropad" src="/assets/images/grid 100_files/grid100+PCB+movement+small+960+copy.gif">
...
<img title="The different iterations of the top module" alt="The different iterations of the top module" src="/assets/images/grid 100_files/GridIterations.jpg">
...
<img title="The lightning connector mount" alt="The lightning connector mount" src="/assets/images/grid 100_files/LightningConnectorDirect.jpeg">

<img title="The lightning connector mount" alt="The lightning connector mount" src="/assets/images/grid 100_files/LightningConnector.jpeg">
...
<img title="The final design in use" alt="The final design in use" src="/assets/images/grid 100_files/GridWorking.jpg">
